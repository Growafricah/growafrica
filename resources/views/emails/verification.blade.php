  ...
  <body>
    <div class="ctr">
      <div class="email">
        ...
        <div class="body">
          <p>
            Dear {{$name}} welcome to the GROW AFRICA platform kindly complete your registration by using the verification code. This code expires in 24 hours
          </p>
          <p>
            <a class="app-link">{{$otp}}</a>
          </p>
          <p>
            If you were not expecting this email, or you think you received it
            in error, <a href="#" class="contact">contact us</a>.
          </p>
          <p></p>
        </div>
        ...
        <div class="footer">
          <p class="unsub">
            This email was sent to <a href="#">{{$email}}</a>
